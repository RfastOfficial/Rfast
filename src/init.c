...
SEXP Rfast_col_min(SEXP x,SEXP parallelSEXP);
SEXP Rfast_col_sums(SEXP xSEXP,SEXP SEXPindices,SEXP na_rmSEXP);
SEXP Rfast_col_min_max(SEXP x, SEXP parallelSEXP);
SEXP Rfast_col_max_indices(SEXP xSEXP);
SEXP Rfast_col_max(SEXP x, SEXP parallelSEXP);
...
SEXP Rfast_gaussian_nb(SEXP XSEXP,SEXP MSEXP,SEXP SSEXP,SEXP lDetsSEXP,SEXP ConSEXP,SEXP kSEXP,SEXP parallelSEXP);
...
SEXP Rfast_row_nth(SEXP xSEXP,SEXP ySEXP,SEXP num_of_nths,SEXP descendSEXP,SEXP na_rmSEXP,SEXP indexSEXP);
...
SEXP Rfast_mat_mult_p(SEXP xSEXP,SEXP ySEXP,SEXP txSEXP,SEXP tySEXP);
